...
parser.add_argument('--dataset', type=str,
                    default='VOC2012', help='experiment_name')
parser.add_argument('--num_classes', type=int,
                    default=22, help='output channel of network')
parser.add_argument('--list_dir', type=str,
                    default='data/VOC2012/', help='list dir')
...
def inference(args, model, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        metric_i, nsa_i = test_single_volume(image, label, model, classes=args.num_classes,
        ...
        # i_batch, case_name,
        # np.mean([k for k in metric_i if k != (0,0)], axis=0)[0],
        # np.mean([k for k in metric_i if k != (0,0)], axis=0)[1]))

    metric_list = metric_list / nsa
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'VOC2012': {
            ...
            'volume_path': 'data/VOC2012',
            'list_dir': 'data/VOC2012',
            'num_classes': 22,
            'z_spacing': 1,
        },
    }
    ...
    log_folder = 'test_log/ntest_log_' + args.exp
